...
class Welcome1Widget extends StatefulWidget {
  ...
  static String routeName = 'Welcome1';
  static String routePath = '/welcome1';
                ...
                child: Align(
                  ...
                  child: Container(
                    ...
                    child: Align(
                      alignment: AlignmentDirectional(0.0, 0.0),
                      child: Text(
                        'We use a gentle, evidence-\nbased technique called the \nCognitive Shuffle to help \nyour child drift off to sleep.',
                        textAlign: TextAlign.center,
                  ...
                  child: Container(
                    ...
                    child: Align(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.asset(
                          'assets/images/sleepingcatwebp.webp',
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
