...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF5CE1E6);
  late Color secondary = const Color(0xFF0F0F0F);
  late Color tertiary = const Color(0xFFFFFFFF);
  late Color alternate = const Color(0xFF0097B2);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF45E38F);
  late Color accent2 = const Color(0xCCE9E4E4);
